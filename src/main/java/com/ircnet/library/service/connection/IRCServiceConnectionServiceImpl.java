...
import com.ircnet.library.common.connection.ConnectionStatusChangedHandler;
...
public class IRCServiceConnectionServiceImpl extends IRCConnectionServiceImpl {
    public IRCServiceConnectionServiceImpl(EventBus eventBus, Parser parser, SettingService settingService,
